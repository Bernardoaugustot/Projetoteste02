...
{
    public class SeedingService  //Estamos Utilizando o WorkFlow Cod-First
    {
        ...
        public void Seed()
        {
            ...
            {
                return; // Db ja esta populado, has been seeded
            }
            else
            {

                Department d1 = new Department(1, "Computers");
                Department d2 = new Department(2, "Electroics");
